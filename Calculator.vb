...
Public Class Calculator
    ...
    Dim enumCurrentOperation As Operations = Operations.None
    ...
    Private Sub btnEquals_Click(sender As Object, e As EventArgs) Handles btnEquals.Click
        If enumCurrentOperation <> Operations.None Then
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        'If iFirstNumber <> "" And enumCurrentOperation <> Operations.None Then
        '    
        If txtMain.Text = "ERROR" Then
            txtMain.Text = "0"
            clean()
            Return
        End If
        If iSecondNumber <> "" Then
            iSecondNumber = iSecondNumber.Substring(0, iSecondNumber.Length - 1)
            txtMain.Text = txtMain.Text.Substring(0, txtMain.Text.Length - 1)
        ElseIf enumCurrentOperation <> Operations.None Then
            enumCurrentOperation = Operations.None
            txtMain.Text = txtMain.Text.Substring(0, txtMain.Text.Length - 1)
            iFirstNumber = ""
        ElseIf txtMain.Text <> "0" And txtMain.Text.Length > 1 Then
            txtMain.Text = txtMain.Text.Substring(0, txtMain.Text.Length - 1)
        Else
            txtMain.Text = "0"
    ...
    Public Function result()
        ...
        If iFirstNumber = "" Or iSecondNumber = "" Then
            stResult = "ERROR"
        Else
